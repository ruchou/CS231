        ...
        \item[(5)]{Sol}
            \begin{enumerate}
                \item [(a)]{Inference Rules}
                    \inferrule{I-Fun}
                    {$\cfrac{  \cfrac{ \cfrac{}{\text{tinfer}(\{ f:X{_0}, x:X{_1} \},f) = \{ F, \{ f:X{_0} \} \}}    ,    ........}{ \text{fresh } X{_1}, \text{tinfer}(\{f:X{_0}, x:X{_1}\}, f (f x) ) = ........}}{ \text{fresh } X{_0} , \text{ tinfer}(\{f:X{_0}\}, \text{function x} \rightarrow f (f x)) =  .......  } \text{I-Fun}$}
                    {tinfer($\emptyset$, function f $\rightarrow$ function x $\rightarrow$ f (f x)) =  ......     }
                \item[(b)]{Sol}
            \end{enumerate}
        \item[(6)]{Sol} \\
