        ...
        \item[(5)]{Sol}
            \begin{enumerate}
                \item [(a)]{Inference Rules}
                    ...
                    {tinfer($\emptyset$, \text{function} f $\rightarrow$ \text{function} x $\rightarrow$ f(fx)) = ($X{_6}$, C )}
                    $ C = \{ F=X{_0}, X=X{_1}, F= X\rightarrow X{_2}, F =  X{_2} \rightarrow X{_4},  X{_5}= X{_0} \rightarrow X{_4}, X{_6}=X{_0}\rightarrow X{_5} \}$ \\
                \item[(b)]{Sol}
            \end{enumerate}
        \item[(6)]{Sol} \\
