        ...
        \item[1]{Sol}\\
            \begin{enumerate}
                \item[(a)] { $((A \wedge B) \wedge C) \rightarrow ( A \wedge ( B \wedge C) )$}\\
                    $ \text{function}\, p:((A \wedge B) \wedge C) \rightarrow ( (fst\,(fst\,p))\; , \; (fst\,(snd\,p) , snd\, p) ) $
...
| Node of 'a * 'a tree * 'a tree
        ...
        \item[(6)]{Sol} \\
            ...
            {tinfer($\Gamma$,match s with left x${_1}$ $\rightarrow$ s${_1}$ $|$ right x${_2}$ $\rightarrow$ t${_2}$)} = $(X, C \cup C{_2} \cup C{_3} \cup \{ S{_1} = S{_2}, S = S{_1} \vee S{_2} \} )$
    \end{description}
