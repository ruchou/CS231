        ...
        \item[4]{Sol}\\
            \begin{enumerate}
                \item[(a)] { \tt f (if x then 0 else 1)}\\
                    ...
                    \end{equation*}
                            \inferrule{T-APP}{
                                $\cfrac{}{\Gamma \vdash \text{f} :  \text{Int} \rightarrow \text{T}}$(T-Var)
                                 \andalso
                                $\cfrac{ \cfrac{}{\Gamma \vdash \text{x} : \text{Bool}}\text{(T-Var)} \quad \cfrac{}{0:\text{Int}}\text{(T-Num)} \quad  \cfrac{}{1:\text{Int}}\text{(T-Num)} }{\Gamma \vdash \text{if x then 0 else 1} :  \text{Int}}$(T-IF)
                ...
                \inferrule{T-APP}{
                    $\cfrac{}{\Gamma \vdash \text{f} :  \text{Int} \rightarrow \text{T}}$(T-Var)
                    \andalso
                    $\cfrac{ \cfrac{ \cfrac{}{\Gamma \vdash \text{f} : \text{Int} \rightarrow \text{Bool} }\text{(T-Var)} \quad \cfrac{}{\Gamma \vdash \text{x : Int}}\text{(T-Var)}  }{\Gamma \vdash \text{f x} : \text{Bool}}\text{(T-App)} \quad \cfrac{}{0:\text{Int}}\text{(T-Num)} \quad  \cfrac{}{1:\text{Int}}\text{(T-Num)} }
