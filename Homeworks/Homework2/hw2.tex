        ...
        \item [(7)]{Sol}
            \begin{enumerate}
                \item [(a)]{New Big-Step Rules}
                    ...
                    \inferrule{B-PLUS}{$t_1 \Downarrow_{k_1} n_1$  \quad $t_2 \Downarrow_{k_2} v_3$ \quad n = n$_1$ $[\![+]\!]$ n$_2$ \quad $k \geq k_1 + k_2$}
                ...
                \item[(b)]{New Big-Step Rules}
                    ...
                    {if $t_1$ then $t_2$ else $t_3$ $\Downarrow_{k}$ timeout}
                    \inferrule{B-PLUSTimeout}{$t_1 \Downarrow_{k_1} n_1$  \quad $t_2 \Downarrow_{k_2} v_3$ \quad n = n$_1$ $[\![+]\!]$ n$_2$ \quad $k < k_1 + k_2$}
                ...
                \item[(c)]{ Type Soundness Theorem}
                    We can decompose this into two simple statements:
                    \begin{enumerate}
                        \item [Progress]:
                            If $t:T$ then either $t$ is a value or exists $t'$ such that $t \Downarrow_k t'$, where $t \not\Downarrow_k timeout$
                        \item[Preservation]:
                            If $t:T$ and $t \Downarrow_k t'$, where $t \not\Downarrow_k timeout$  , then $t':T$
                    \end{enumerate}
